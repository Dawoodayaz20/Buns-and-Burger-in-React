  ...
  return (
    <header className="bg-red-700 text-yellow-200 fixed w-full top-0 left-0 flex flex-col md:flex-row justify-between items-center z-50 py-4 px-8">
      ...
      <nav id="navbar" className="flex gap-4">
        ...
        <Link className="text-yellow-200 rounded-lg px-4 py-2 text-base md:text-lg font-bold transition duration-200 hover:bg-yellow-200 hover:text-red-700 hover:font-extrabold" to="/auth"></Link>
      </nav>
    </header>
  );
};
